...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { description: @season.description, league_id: @season.league_id, name: @season.name }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { description: @season.description, league_id: @season.league_id, name: @season.name }
    assert_redirected_to season_path(assigns(:season))
  end
