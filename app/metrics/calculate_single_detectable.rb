module Metrics
  class CalculateSingleDetectable
    def initialize(configReader, streamDetection, detectableId)
      @configReader = configReader
      @streamDetection = streamDetection
      @detectableId = detectableId

      @width = @streamDetection.width
      @height = @streamDetection.height

      # sliding windows
      @dgcSlidingWindow = Metrics::MetricsSlidingWindow.new(
        @streamDetection.detection_frame_rate,
      ...
      @teSlidingWindow = Metrics::MetricsEventDistance.new(
        @streamDetection.event_detections,
